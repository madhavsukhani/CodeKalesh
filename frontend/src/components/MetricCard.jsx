...
export default function MetricCard({ 
  ...
  return (
    <div className={`relative p-4 rounded-xl bg-gradient-to-b ${currentTheme} bg-slate-900/70 border backdrop-blur-sm shadow-md transition-all hover:border-slate-600/60 group`}>
      <div className="flex items-center justify-between">
        <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">{title}</span>
        {Icon && (
            <div className="p-1.5 rounded-lg bg-slate-800/80 border border-slate-700/60 text-slate-300 group-hover:text-white transition-colors">
